 ...
 * correctly validated
 */
public class LoadVepAnnotationStepParametersValidatorTest {
    private LoadVepAnnotationStepParametersValidator validator;
    ...
    public void setUp() throws Exception {
        ...
        validator = new LoadVepAnnotationStepParametersValidator(studyIdRequired);
    ...
    public void inputVcfIdIsNotRequired() throws JobParametersInvalidException, IOException {
        ...
        validator = new LoadVepAnnotationStepParametersValidator(studyIdNotRequired);
        validator.validate(new JobParameters(requiredParameters));
    }
