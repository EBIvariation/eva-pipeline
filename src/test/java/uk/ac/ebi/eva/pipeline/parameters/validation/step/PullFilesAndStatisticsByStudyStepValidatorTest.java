...
/**
 * Tests that the arguments necessary to run a
 * {@link uk.ac.ebi.eva.pipeline.jobs.steps.PullFilesAndStatisticsByStudyStep} are correctly validated
 */
public class PullFilesAndStatisticsByStudyStepValidatorTest {

    private PullFilesAndStatisticsByStudyStepValidator validator;
    ...
    public void setUp() throws IOException {
        validator = new PullFilesAndStatisticsByStudyStepValidator();
