...
/**
 * Tests that the arguments necessary to run a {@link uk.ac.ebi.eva.pipeline.jobs.steps.DropFilesByStudyStep}
 * are correctly validated
 */
public class DropFilesByStudyStepValidatorTest {

    private DropFilesByStudyStepValidator validator;
    ...
    public void setUp() throws IOException {
        validator = new DropFilesByStudyStepValidator();
