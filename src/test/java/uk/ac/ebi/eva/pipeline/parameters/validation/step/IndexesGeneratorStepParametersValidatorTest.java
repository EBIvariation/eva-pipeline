 ...
 * correctly validated
 */
public class IndexesGeneratorStepParametersValidatorTest {
    private IndexesGeneratorStepParametersValidator validator;
    ...
    public void setUp() throws Exception {
        validator = new IndexesGeneratorStepParametersValidator();
