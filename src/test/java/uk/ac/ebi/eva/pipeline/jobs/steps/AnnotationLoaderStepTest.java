...
@ContextConfiguration(classes = {AnnotationLoaderStep.class, BatchTestConfiguration.class})
public class AnnotationLoaderStepTest {
    ...
    public void shouldLoadAllAnnotations() throws Exception {
        ...
        JobExecution jobExecution = stepLauncherTestUtils.launchStep(BeanNames.LOAD_VEP_ANNOTATION_STEP, jobParameters);
