...
import uk.ac.ebi.eva.t2d.parameters.validation.job.steps.GeneratePedStepValidator;
...
public class GeneratePedValidator extends CompositeJobParametersValidator {

    public GeneratePedValidator() {
        super();
        List<JobParametersValidator> jobParametersValidators = new ArrayList<>();
        jobParametersValidators.add(new GeneratePedStepValidator());
