...
public class SampleWriterConfiguration {

    @Bean(T2D_SAMPLE_WRITER)
    @StepScope
    public SampleWriter sampleWriterConfiguration(T2dService t2dService) {
        return new SampleWriter(t2dService);
    }
