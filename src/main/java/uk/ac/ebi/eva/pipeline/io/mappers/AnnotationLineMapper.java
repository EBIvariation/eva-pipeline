...
public class AnnotationLineMapper implements LineMapper<AnnotationMongo> {
    ...
    public AnnotationMongo mapLine(String line, int lineNumber) {
        ...
        AnnotationMongo currentAnnotation = new AnnotationMongo(
                AnnotationMongo.buildAnnotationId(variantMap.get("chromosome"),  Long.valueOf(variantMap.get("start")), variantMap.get("reference"), variantMap.get("alternative"), vepVersion, vepCacheVersion),
                ...
                vepCacheVersion,
                null,
                new HashSet<ConsequenceTypeMongo>(){{add(consequenceType);}});
