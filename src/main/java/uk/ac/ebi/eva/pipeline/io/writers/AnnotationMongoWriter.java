...
import static uk.ac.ebi.eva.commons.mongodb.entities.subdocuments.ConsequenceTypeMongo.SO_ACCESSION_FIELD;
import static uk.ac.ebi.eva.commons.mongodb.entities.subdocuments.XrefMongo.XREF_ID_FIELD;
...
public class AnnotationMongoWriter implements ItemWriter<List<AnnotationMongo>> {
    ...
    private static final String ANNOTATION_XREF_ID_FIELD = XREFS_FIELD + "." + XREF_ID_FIELD;
