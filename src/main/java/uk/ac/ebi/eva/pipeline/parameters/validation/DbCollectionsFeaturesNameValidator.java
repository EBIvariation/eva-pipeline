...
/**
 * Checks that the name of the features collection has been filled in.
 *
 * @throws JobParametersInvalidException If the features collection name is null or empty
 */
