...
/**
 * Validates the job parameters necessary to execute a {@link uk.ac.ebi.eva.pipeline.jobs.steps.DropFilesByStudyStep}
 */
public class DropFilesByStudyStepValidator extends DefaultJobParametersValidator {

    public DropFilesByStudyStepValidator() {
